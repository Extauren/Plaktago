...
List<CardName> cardNameList = [
  ...
  CardName("Solo", plaqueTypeList.all, 1),
  CardName("Couple / Duo", plaqueTypeList.all, 1),
  CardName("Attent un pote", plaqueTypeList.all, 1),
  CardName("Laisse la plque ouverte", plaqueTypeList.all, 1),
  CardName("Fifi tier", plaqueTypeList.all, 1),
  ...
  CardName("Trop propre", plaqueTypeList.all, 1),
  CardName("Fusion de groupe", plaqueTypeList.all, 1),
  CardName("Tous dans le même tenue", plaqueTypeList.all, 1),
];
