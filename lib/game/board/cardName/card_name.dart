...
List<CardName> cardNameListPlaque = [
  ...
  CardName(name: "Bus",type: [BingoType.plaque, BingoType.kta],icon: "0xe533",description: "Groupe supérieur à 5 personnes", difficulty: Difficulty.medium),
  ...
  CardName(name: "Copain", type: [BingoType.plaque, BingoType.kta], icon: "0xf234", description: "Ami qui n'était pas prévu", difficulty: Difficulty.medium),
