...
List<CardName> cardNameListPlaque = [
  ...
  CardName(name: "Taggeur", type: [BingoType.kta], icon: "0xf5bd", description: "Personne en train de tagger ou ordeur de bomb dans une galerie"),
  CardName(name: "Bourré / Défoncé", type: [BingoType.kta], icon: "0xf0fc", description: "Quelqu'un de trop bourré ou défoncé"),
  CardName(name: "Animal domestic", type: [BingoType.kta], icon: "0xf6d3", description: "Animal domestic descendus par une personne"),
  ...
  CardName(name: "Repas",type: [BingoType.kta],icon: "0xf2e7", description: "Repas partagé consistant et/ou cuisine élaborée =! Sandwich/Houmous etc"),
