...
List<CardName> cardNameListPlaque = [
  ...
  CardName(name: "Solitaire",type: [BingoType.kta, BingoType.plaque],icon: "0xf406", description: "Personne seul", difficulty: Difficulty.easy),
  ...
  CardName(name: "File d'attente", icon: "0xe592",type: [BingoType.kta, BingoType.plaque], description: "Temps d'attente à une chatière ou à une plaque", difficulty: Difficulty.easy),
