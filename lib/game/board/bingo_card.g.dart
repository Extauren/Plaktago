...
const BingoCardSchema = IsarGeneratedSchema(
  schema: IsarSchema(
    name: 'BingoCard',
    embedded: true,
    properties: [
  ...
  converter: IsarObjectConverter<void, BingoCard>(
    serialize: serializeBingoCard,
    deserialize: deserializeBingoCard,
  ),
);

@isarProtected
int serializeBingoCard(IsarWriter writer, BingoCard object) {
  IsarCore.writeString(writer, 1, object.name);
  IsarCore.writeBool(writer, 2, object.isSelect);
  IsarCore.writeLong(writer, 3, object.nbLineComplete);
  IsarCore.writeLong(writer, 4, object.order);
  IsarCore.writeString(writer, 5, object.alcoolRule);
  IsarCore.writeLong(writer, 6, object.nbShot);
  return 0;
}

@isarProtected
BingoCard deserializeBingoCard(IsarReader reader) {
  final String _name;
  _name = IsarCore.readString(reader, 1) ?? "";
  final bool _isSelect;
  _isSelect = IsarCore.readBool(reader, 2);
  final int _nbLineComplete;
  {
    final value = IsarCore.readLong(reader, 3);
    if (value == -9223372036854775808) {
      _nbLineComplete = 0;
    } else {
      _nbLineComplete = value;
    }
  }
  final int _order;
  {
  ...
  final String _alcoolRule;
  _alcoolRule = IsarCore.readString(reader, 5) ?? "";
  final int _nbShot;
  {
  ...
  final object = BingoCard(
    name: _name,
    isSelect: _isSelect,
    nbLineComplete: _nbLineComplete,
    order: _order,
    alcoolRule: _alcoolRule,
    nbShot: _nbShot,
  );
  return object;
}
...
extension BingoCardQueryFilter
  ...
  QueryBuilder<BingoCard, BingoCard, QAfterFilterCondition>
      nbLineCompleteGreaterThanOrEqualTo(
    int value,
  ) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
  ...
  QueryBuilder<BingoCard, BingoCard, QAfterFilterCondition>
      nbLineCompleteLessThanOrEqualTo(
    int value,
  ) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
  ...
  QueryBuilder<BingoCard, BingoCard, QAfterFilterCondition>
      alcoolRuleGreaterThanOrEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
