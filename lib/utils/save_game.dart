...
class CardList {
  ...
  CardList({this.cardName = "", this.nbPlayed = 0, this.nbCheck = 0});
}
...
//   Future<General> getGeneralStats() async {
...
//       directory: dir.path,
//     );
//     general = await isar.generals.get(1);
//     if (general == null) {
//       return General();
//     }
//     return general;
...
//     General generalStats = await getGeneralStats();
